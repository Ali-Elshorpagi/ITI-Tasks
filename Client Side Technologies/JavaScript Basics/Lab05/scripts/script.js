...
function display(products) {
    ...
    for (let item of products) {
        ...
        addToFavBtn.classList = 'addToFav';
        ...
        addToCartBtn.addEventListener('click', (function (product) {
            return function () {
                ...
                if (cart)
                    ...
                    cart = [];
                let existingItem = cart.find(function (p) {
        ...
        addToFavBtn.addEventListener('click', (function (product) {
            return function () {
                ...
                let existingItem = fav.find(function (p) {
                    return p.id === product.id;
                });
        ...
        productDiv.appendChild(addToFavBtn);
