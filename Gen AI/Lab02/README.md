# Lab02 - ChatGPT UI Clone (Gemini + Hugging Face + OpenAI Speech)

## Lab Description
This lab builds a full-stack AI chat application with a modern web interface and multi-provider AI services. It demonstrates practical integration of text generation, image generation, file attachments, speech features, and persistent chat UX.

## Main Objectives
- Build a responsive chat-style frontend with persistent UI state.
- Integrate Gemini for conversational responses.
- Support optional Hugging Face and OpenAI services.
- Implement speech-to-text and text-to-speech workflows.
- Manage API keys and environment configuration securely.
