...
{
    system("cls");
    char menu[BASE_ROWS][COLS] = {"New", "Display all employees", "Delete  by Id", "Delete by Name", "Deleted Employees", "Swap two integers", "Exit"};
    ...
    do
    {
        ...
        case ENTER:
        {
            ...
            {
                int sub_choiced(0);
                char submenu[SUB_ROWS][COLS] = {"Add new employee", "Display an employee", "Back"};
                char sub_ch;
                ...
                do
                {
                    ...
                    else if (sub_ch == ENTER)
                    {
                        if (!sub_choiced) // Add new employee
                        {
                            ...
                            cout << "----------------------------------------";
                            gotoxy(10, 8);
                            cout << "Enter the index of place that you want the employee added (1 - 15): ";
                            int idx;
                            cin >> idx;
                            if (idx < ROWS)
                            {
                                ...
                                {
                                    gotoxy(10, 10);
                                    cout << "\n\t Warning: An employee already exists at this index. Do you want to override [Y/N]: ";
                                ...
                                {
                                    gotoxy(10, 8);
                                    cout << "\n\t Warning: An employee already exists at this index but deleted.";
                                    add_employee(&ptr[idx - 1]);
                                    ++employees_count;
                                }
                                else
            ...
            case 2:
            {
                ...
                for (int i(0); i < ROWS; ++i)
                {
                    if (ptr[i].Id == delete_id)
                    {
                        ...
                        gotoxy(10, 8);
                        cout << "\t>>> Employee with Id " << delete_id << " deleted successfully!";
                        break;
                    }
                }
                if (!found)
            ...
            case 3:
            {
                ...
                for (int i(0); i < ROWS; ++i)
                {
                    if (ptr[i].Name == delete_name)
                    {
                        ptr[i].Id = -2, found = true, --employees_count;
                        gotoxy(10, 30);
                        cout << "\t>>> Employee with Name " << delete_name << " deleted successfully!";
                        break;
                    }
                }
                if (!found)
